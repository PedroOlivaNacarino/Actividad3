...
El objetivo de la atividad es aplicar los conceptos estadísticos y análisis multivariante a un conjunto de datos. Para ello, se realizarán 7 pasos.
...
# Explorar dataframe, seleccionar genes y eliminar filas con valores NA
...
shapiro_res_table <- table(shapiro_res$normal_aprox)

# Lista de tests Shapiro para cada gen
norm_genes_testSha <- lapply(df_genes, shapiro.test)

# Crear resumen con todas las filas visibles
...
# Mostrar todas las filas completas
print(resumen_normalidad, n = Inf)
...
```{R fig.width = 14, fig.height = 10, echo = TRUE, warning = FALSE}
...
#### Paso 7. Regresión logística (con marcadores tumorales)
